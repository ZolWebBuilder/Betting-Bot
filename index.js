...
const v3 = [
  ...
  {name:'higherlower',description:'Guess if the next number is higher or lower',options:[{type:3,name:'guess',description:'Higher or Lower',required:true,choices:[{name:'Higher',value:'higher'},{name:'Lower',value:'lower'}]}],integration_types:[0,1],contexts:[0,1,2]},
  ...
  {name:'evenodd',description:'Guess if a number is even or odd',options:[{type:3,name:'guess',description:'Even or Odd',required:true,choices:[{name:'Even',value:'even'},{name:'Odd',value:'odd'}]}],integration_types:[0,1],contexts:[0,1,2]},
